...
/*		double relX = x -= self.getX();
    ...
    public static double findPointRiskBasic(HashMap<String, Enemy> enemies, Point2D.Double point)
    {
    	double risk = 0;
    ...
    public static Point2D.Double[] minimumRiskBasic(SleepSiphon self, HashMap<String, Enemy> enemies)
    {
...
/*				self.setTurnRightRadians(turnAngle);
	...
	public static WeightedPoint[] circleDistribution_NeverClosest2(SleepSiphon self, Ellipse2D.Double[] circles, HashMap<String, Enemy> enemies, double HYPOT)
	{
	    int NUM_POINTS = 32;
